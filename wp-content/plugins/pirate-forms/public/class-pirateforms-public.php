	...
	public function display_form( $atts, $content = null ) {
		...
		if ( ! empty( $pirate_forms_options ) ) :
			...
			if ( ! empty( $field ) && ! empty( $label ) ) :
				...
				$wrap_classes = array(
					( ! empty( $subjectField ) ? 'col-xs-12 col-sm-12' : 'col-xs-12 col-sm-12' ) . ' contact_name_wrap pirate_forms_three_inputs form_field_wrap',
				);
			...
			if ( ! empty( $field ) && ! empty( $label ) ) :
				$required     = $field === 'req' ? true : false;
				$wrap_classes = array(
					( ! empty( $subjectField ) ? 'col-xs-12 col-sm-12' : 'col-xs-12 col-sm-12' ) . ' contact_email_wrap pirate_forms_three_inputs form_field_wrap',
				);
				// If this field was submitted with invalid data
			...
			if ( ! empty( $field ) && ! empty( $label ) ) :
				$required     = $field === 'req' ? true : false;
				$wrap_classes = array(
					'col-xs-12 col-sm-12 contact_subject_wrap pirate_forms_three_inputs form_field_wrap',
				);
				// If this field was submitted with invalid data
